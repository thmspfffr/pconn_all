...
plotdir  = '/home/tpfeffer/pconn_all/proc/plots/';
...
for ifoi = 1 : 4
  for isubj = SUBJLIST
    for m = 1 : 3
      ...
      pow_res_all(:,isubj,m,ifoi)  = nanmean(par.pow,2); clear par
...
%     
%     save(sprintf('~/pconn_all/proc/all_sens_tsk_%s_clusterstat_contr%d_f%d_v%d.mat',str,icontr,ifoi,v_cnt),'stats');
%     
%   end
% end
% 
...
%     [stats] = ft_freqstatistics(cfg, data_low);
%     
%     save(sprintf('~/pconn_all/proc/all_sens_res_%s_clusterstat_contr%d_f%d_v%d.mat',str,icontr,ifoi,v_cnt),'stats');
%     
%   end
% end
% 
...
%   [stats] = ft_freqstatistics(cfg, data_low);
%   
%   save(sprintf('~/pconn_all/proc/all_sens_%s_clusterstat_cnt-rest_f%d_v%d.mat',str,ifoi,v_cnt),'stats');
%   
% end
...
for ifoi = 1 : 4
  ...
  for icontr = 1 : 3
    ...
    save(sprintf('~/pconn_all/proc/all_sens_%s_clusterstat_diffdiff_c%d_f%d_v%d.mat',str,icontr,ifoi,v_cnt),'stats');
