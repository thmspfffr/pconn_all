...
for v = [1 2 9]
  ...
  for istr = 1 : length(allstr)
    ...
    if ~exist(sprintf([outdir 'all_sens_clusterstat_filt_s%d_v%d_processing.txt'],istr,v_out))
      system(['touch ' outdir sprintf('all_sens_clusterstat_filt_s%d_v%d_processing.txt',istr,v_out)]);
    else
      continue
    end
    ...
    for ifoi = 1 : 4
      for isubj = SUBJLIST
        for m = 1 : 3
          ...
          load(sprintf(['~/pconn_cnt/proc/dfa/' 'pconn_cnt_sens_dfa_filt_s%d_m%d_f%d_v%d.mat'],isubj,im,ifoi,v_cnt));
    ...
    for ifoi = 1 : 4
      ...
      for icontr = 1 : 3
        ...
        save(sprintf('~/pconn_all/proc/all_sens_filt_tsk_%s_clusterstat_contr%d_f%d_v%d.mat',str,icontr,ifoi,v_out),'stats','SUBJLIST');
    ...
    for ifoi = 1 : 4
      ...
      for icontr = 1 : 3
        ...
        save(sprintf('~/pconn_all/proc/all_sens_filt_res_%s_clusterstat_contr%d_f%d_v%d.mat',str,icontr,ifoi,v_out),'stats','SUBJLIST');
    ...
    for ifoi = 1 : 4
      ...
      save(sprintf('~/pconn_all/proc/all_sens_filt_%s_clusterstat_cnt-rest_f%d_v%d.mat',str,ifoi,v_out),'stats','SUBJLIST');
    ...
    for ifoi = 1 : 4
      ...
      for icontr = 1 : 3
        ...
        save(sprintf('~/pconn_all/proc/all_sens_filt_%s_clusterstat_diffdiff_c%d_f%d_v%d.mat',str,icontr,ifoi,v_out),'stats','SUBJLIST');
